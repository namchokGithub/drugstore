...
('BC00000006', '2019-11-27', '100.00', '150.00', '2019-11-27', 'จ่ายแล้ว', '1000', '0003', 'Tm0003', NULL),
('BC0000007', '2019-11-28', '450.00', '450.00', '2019-11-28', 'เงินสด', '1000', '0004', 'Tm0006', 1);
...
('1000', '99.00', 'P000000002', '1012000000'),
...
CREATE TABLE `DETAILTREATMENT` (
  ...
  `DETAIL_TM_DESCRIPTION` varchar(100) NOT NULL,
...
INSERT INTO `DETAILTREATMENT` (`DETAIL_TM_ID`, `DETAIL_TM_DESCRIPTION`, `DETAIL_TM_AMOUNT`, `DETAIL_TM_PRICE`, `TM_ID`, `PD_ID`) VALUES
('DTM0000001', 'ถอนฟัน', 1, '400.00', 'Tm0001', '2030000000'),
('DTM0000002', 'ผ่าฟันคุด', 4, '1000.00', 'Tm0002', '2050000000'),
('DTM0000003', 'ซื้อน้ำยาบวนปาก', 3, '200.00', 'Tm0004', '2060000000'),
('DTM0000004', 'อุดฟัน', 1, '240.00', 'Tm0003', '2030000000'),
('DTM0000005', 'ถอนฟัน', 2, '500.00', 'Tm0004', '2040000000'),
('DTM0000006', 'ถอนฟันล่าง', 1, '450.00', 'Tm0006', '2050000000');
...
('EMP000001', 'บริการ', 'ดีเยี่ยม', '0987542115', 'กรุงเทพฯ', 'ิborikarrn7@gmail.com', '1995-08-09', '9000.00', '50.00', '1475849562143', '2018-11-06', 'B000000002', '1801254202');
...
INSERT INTO `PRODUCT` (`PD_ID`, `PD_NAME`, `PD_TYPE`, `PD_RETAIL_PRICE`, `PD_SALE_PRICE`, `PD_AMOUNT`, `PD_DESCRIPTION`) VALUES
...
('S00005', '12:00:00', '16:00:00', 'ลูกค้าต้องการถอนฟัน', '2019-11-20', '2019-11-23', 'ยังไม่ได้รับการรักษา', '1000', '0003');
...
('Tm0005', '2019-11-28', '150.00', '3000', '0003'),
('Tm0006', '2019-11-28', '450.00', '1000', '0004');
