...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-navbar py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <div class="site-logo">
                <a href="index.html" class="js-logo-clone">ยาหมีบอก</a>
                </div>
            </div>
            <!-- end logo -->
            <div class="main-nav d-none d-lg-block">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li><a href="shop.html">ร้านขายยา</a></li>
                    <li><a href="about.html">เกี่ยวกับร้านค้า</a></li>
    ...
    <!-- First section -->
    <div class="site-blocks-cover" style="background-image: url('assets/images/bg_5.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <h1>ยินดีต้อนรับ</h1>
              <p>
                <a href="#" class="btn btn-ds-white px-5 py-3">ซื้อยา</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12 block-3 products-wrap">
            <div class="nonloop-block-3 no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="assets/images/person_1.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="assets/images/person_2.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="assets/images/person_3.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                  <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis voluptatem consectetur quam tempore
                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur ducimus. Minus ratione sit quaerat
                    unde.&rdquo;</p>
                </blockquote>
